...
- Create Angular project with ng: `ng new angularapptotestonlaptop.client --defaults --skip-install --skip-git `.
...
- Create project file (`angularapptotestonlaptop.client.esproj`).
